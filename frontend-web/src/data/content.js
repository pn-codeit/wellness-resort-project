...
const home = {
  de: {
    ...
    heroTitle: 'Wo Natur und<br><span class="hero-gold">Stille</span><br>sich begegnen',
    heroDesc: 'Ihr exklusiver Rückzugsort in den Allgäuer Alpen',
    heroStats: [
      { num: '120', label: 'Exklusive Suiten' },
      { num: '3.500 m²', label: 'Private Spa' },
      { num: '365 Tage', label: 'Alpenpanorama' },
      { num: '4.9 / 5', label: 'Gästezufriedenheit' }
    ],
  ...
  en: {
    heroSub: 'Oberstdorf, Allgäu',
    heroTitle: 'Where Nature and <span class="hero-gold">Silence</span> Meet',
    heroDesc: 'Your exclusive retreat in the Allgäu Alps',
    heroStats: [
      { num: '120', label: 'Exclusive Suites' },
      { num: '3.500 m²', label: 'Private Spa' },
      { num: '365 Days', label: 'Alpine Panorama' },
      { num: '4.9 / 5', label: 'Guest Satisfaction' }
    ],
...
const impressions = {
  de: {
    ...
    uploadTitle: 'Dein Erlebnis zählt',
    uploadSubtitle: 'Warst du schon bei uns zu Gast? Teile deine schönsten Momente und inspiriere zukünftige Gäste – dein Bild erscheint direkt in unserer Galerie.',
    uploadDrop: 'Foto hierher ziehen oder',
    uploadBrowse: 'Datei auswählen',
    uploadHint: 'JPG, PNG, WEBP · max. 10 MB',
    uploadButton: 'Jetzt hochladen',
    uploadSuccess: 'Dein Bild wurde hochgeladen – vielen Dank! Es erscheint gleich in der Galerie.',
    uploadError: 'Upload fehlgeschlagen. Bitte versuche es erneut.',
    guestPhotoLabel: 'Gästefoto',
    guestPhotoCategory: 'Gästefotos'
  },
  en: {
    title: 'Gallery',
    ...
    uploadTitle: 'Your Experience Matters',
    uploadSubtitle: 'Have you stayed with us? Share your favourite moments and inspire future guests — your photo will appear directly in our gallery.',
    uploadDrop: 'Drag your photo here or',
    uploadBrowse: 'Browse files',
    uploadHint: 'JPG, PNG, WEBP · max. 10 MB',
    uploadButton: 'Upload now',
    uploadSuccess: 'Your photo has been uploaded – thank you! It will appear in the gallery shortly.',
    uploadError: 'Upload failed. Please try again.',
    guestPhotoLabel: 'Guest Photo',
    guestPhotoCategory: 'Guest Photos'
  }
};
